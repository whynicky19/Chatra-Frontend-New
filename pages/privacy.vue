...
const content = {
  ru: {
    ...
    sections: [
      ...
      { t: 'Как мы используем данные', b: 'Мы используем данные, чтобы предоставлять функции сервиса: создавать классы и задания, обмениваться сообщениями, выставлять оценки, обрабатывать запросы к ИИ-помощнику, доставлять уведомления и восстанавливать доступ к аккаунту.\n\nТехнические данные используются для обеспечения безопасности, предотвращения злоупотреблений и повышения стабильности сервиса.\n\nМы не используем ваши данные в рекламных целях и не передаём их рекламным сетям.' },
      ...
      { t: 'Ваши права', b: 'Вы можете в любой момент просмотреть и изменить данные профиля, пожаловаться на контент или заблокировать другого пользователя, а также удалить аккаунт вместе со связанными данными в разделе «Настройки → Удалить аккаунт». Удаление аккаунта необратимо.\n\nВ зависимости от страны проживания вы также можете иметь право запросить копию своих данных, их исправление или ограничение обработки. Для этого напишите нам — мы ответим в разумный срок.' },
  ...
  en: {
    ...
    sections: [
      ...
      { t: 'How we use data', b: 'We use your data to provide the features of the service: creating classes and assignments, exchanging messages, grading work, processing your requests to the AI assistant, delivering notifications and restoring access to your account.\n\nTechnical data is used to keep the service secure, prevent abuse and improve stability.\n\nWe do not use your data for advertising and do not share it with ad networks.' },
      ...
      { t: 'Your rights', b: 'At any time you can review and edit your profile data, report content or block another user, and delete your account together with its data in Settings → Delete account. Account deletion is irreversible.\n\nDepending on where you live, you may also have the right to request a copy of your data, its correction, or a restriction on its processing. Contact us and we will respond within a reasonable time.' },
  ...
  kk: {
    ...
    sections: [
      ...
      { t: 'Деректерді қалай пайдаланамыз', b: 'Деректерді сервис функцияларын ұсыну үшін пайдаланамыз: сыныптар мен тапсырмалар құру, хабарлама алмасу, баға қою, ИИ-көмекшіге сұрауларды өңдеу, хабарландырулар жіберу және аккаунтқа қолжетімділікті қалпына келтіру.\n\nТехникалық деректер қауіпсіздікті қамтамасыз ету, теріс пайдаланудың алдын алу және сервис тұрақтылығын арттыру үшін қолданылады.\n\nБіз деректеріңізді жарнама мақсатында пайдаланбаймыз және жарнама желілеріне бермейміз.' },
      ...
      { t: 'Сіздің құқықтарыңыз', b: 'Кез келген уақытта профиль деректерін қарап, өзгерте аласыз, контентке шағымдана немесе басқа пайдаланушыны бұғаттай аласыз, сондай-ақ «Баптаулар → Аккаунтты жою» бөлімінде аккаунтты байланысты деректерімен бірге жоя аласыз. Аккаунтты жою қайтарылмайды.\n\nТұрғылықты еліңізге байланысты деректеріңіздің көшірмесін сұрауға, оларды түзетуге немесе өңдеуді шектеуге құқығыңыз болуы мүмкін. Ол үшін бізге жазыңыз — ақылға қонымды мерзімде жауап береміз.' },
