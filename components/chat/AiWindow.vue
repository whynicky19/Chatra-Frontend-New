...
.ai-av { width: 38px; height: 38px; border-radius: var(--r-lg); background: linear-gradient(135deg, var(--teal-h), #4dd6e8); display: flex; align-items: center; justify-content: center; color: #fff; box-shadow: 0 4px 12px rgba(var(--teal-rgb),.4) }
...
.ai-welcome-icon { width: 72px; height: 72px; border-radius: var(--r-2xl); background: linear-gradient(135deg, var(--teal-h), #4dd6e8); display: flex; align-items: center; justify-content: center; color: #fff; margin-bottom: 16px; box-shadow: 0 8px 24px rgba(var(--teal-rgb),.4); animation: float 3s ease-in-out infinite }
...
.ai-av-m.u { background: linear-gradient(135deg, var(--teal-h), var(--teal)); color: #fff }
...
.ai-img-prev { max-width: 200px; max-height: 160px; border-radius: 10px; object-fit: cover; border: 1px solid rgba(var(--teal-rgb),.2); margin-bottom: 4px }
.ai-bbl { padding: 12px 16px; border-radius: var(--r-xl); font-size: 14px; line-height: 1.6 }
.ai-msg.user .ai-bbl { background: linear-gradient(135deg, var(--teal-h), var(--teal)); color: #fff; border-bottom-right-radius: 4px; box-shadow: 0 4px 12px rgba(var(--teal-rgb),.3) }
...
.ai-attach-icon:hover { background: rgba(var(--teal-rgb),.12); border-color: rgba(var(--teal-rgb),.2); color: var(--teal) }
...
.ai-field:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(var(--teal-rgb),.15) }
