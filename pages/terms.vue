...
const content = {
  ru: {
    ...
    sections: [
      ...
      { t: 'Правила поведения', b: 'Chatra — учебная среда, поэтому мы ожидаем добросовестного использования её функций. Запрещается загружать незаконный, оскорбительный или защищённый чужими правами контент, использовать платформу для мошенничества, распространения вредоносных ссылок, а также любым способом нарушать закон или права других лиц.\n\nОсобое внимание уделяется академической честности: ИИ-ассистент предназначен помогать в обучении, а не подменять самостоятельную работу. Использование его ответов для списывания, выдачи чужой работы за свою или иных форм академического мошенничества запрещено и может повлечь ограничение доступа к аккаунту.' },
  ...
  en: {
    ...
    sections: [
      ...
      { t: 'Rules of conduct', b: 'Chatra is a learning environment, so we expect its features to be used in good faith. You may not upload illegal, abusive or third-party-protected content, use the platform for fraud or to distribute malicious links, or in any way break the law or violate the rights of others.\n\nWe pay particular attention to academic integrity: the AI assistant is meant to support learning, not to replace independent work. Using its responses for cheating, passing off someone else\'s work as your own, or other forms of academic misconduct is prohibited and may result in your account access being restricted.' },
  ...
  kk: {
    ...
    sections: [
      ...
      { t: 'Мінез-құлық ережелері', b: 'Chatra — оқу ортасы, сондықтан біз оның функцияларын адал пайдалануды күтеміз. Заңсыз, қорлайтын немесе басқа біреудің құқығымен қорғалған мазмұнды жүктеуге, платформаны алаяқтық немесе зиянды сілтемелерді таратуға пайдалануға, сондай-ақ кез келген жолмен заңды немесе басқалардың құқығын бұзуға тыйым салынады.\n\nАкадемиялық адалдыққа ерекше көңіл бөлінеді: ЖИ-көмекші оқуға көмектесуге арналған, дербес жұмысты алмастыруға емес. Оның жауаптарын көшіру, басқа біреудің жұмысын өз атынан беру немесе академиялық алаяқтықтың басқа түрлері үшін пайдалануға тыйым салынады және аккаунтқа қолжетімділіктің шектелуіне алып келуі мүмкін.' },
