<template>
  <div class="org-shell">
    <div class="org-content">
      ...
      <!-- Логотип: перекрашивается под акцентный цвет выбранной организации -->
      ...
      <div class="org-head r2">
        ...
        <p class="org-sub">{{ tt('Выберите тип организации',
          'Ұйым түрін таңдаңыз',
...
const logoGradient = computed(() => picked.value === 'school'
  ? 'linear-gradient(180deg, #FBBF24, #B45309)'
  : 'linear-gradient(180deg, #40D0E4, #00829C)')
