...
const content = {
  ru: {
    ...
    sections: [
      ...
      { t: 'Правила поведения', b: 'Chatra — учебная среда, поэтому мы ожидаем от вас добросовестного и ответственного использования сервиса. Запрещается размещать оскорбительные, дискриминационные, мошеннические или вредоносные материалы, загружать контент, нарушающий закон или права третьих лиц, а также использовать сервис для академических нарушений — например, для выдачи ответов ИИ за собственную работу вопреки правилам учебного заведения.\n\nК подобным нарушениям применяется политика нулевой терпимости: нарушающий контент удаляется, а доступ нарушителя к сервису может быть ограничен или прекращён.' },
      { t: 'Использование искусственного интеллекта', b: 'В сервисе доступны функции на основе искусственного интеллекта: ИИ-ассистент, генерация учебных материалов и автоматическая проверка заданий. Эти функции запускаются только по вашей инициативе.\n\nОтветы ИИ формируются автоматически и могут содержать неточности или ошибки. Они носят вспомогательный характер, не заменяют профессиональную оценку преподавателя и не являются юридической, медицинской или иной специализированной консультацией — воспринимайте их критически и проверяйте важные факты самостоятельно. ИИ-проверка запускается преподавателем, и выставленную оценку преподаватель может изменить.\n\nЗапрещается использовать функции ИИ для создания противоправного контента, обхода правил учебного заведения или введения других пользователей в заблуждение.' },
      { t: 'Учебные материалы и пользовательский контент', b: 'Права на материалы, которые вы создаёте или загружаете в сервисе — задания, ответы, учебные файлы и материалы для ИИ-ассистента, — остаются за вами или их правообладателями.\n\nЗагружая контент, вы предоставляете нам ограниченное право хранить, обрабатывать и отображать его в объёме, необходимом для работы сервиса: показа участникам вашего класса, синхронизации между устройствами, работы ИИ-ассистента с вашими материалами и выполнения запрошенных вами функций.\n\nВы подтверждаете, что обладаете необходимыми правами на размещаемые материалы. Мы вправе удалить контент, нарушающий эти Условия или законодательство.' },
  ...
  en: {
    ...
    sections: [
      ...
      { t: 'Rules of conduct', b: 'Chatra is a learning environment, so we expect responsible and good-faith use of the service. You may not upload offensive, discriminatory, fraudulent or malicious material, content that breaks the law or violates the rights of others, or use the service for academic dishonesty — for example, submitting AI-generated answers as your own work in violation of your institution’s rules.\n\nWe apply a zero-tolerance policy to such violations: offending content is removed and a violator’s access to the service may be restricted or terminated.' },
      { t: 'Use of artificial intelligence', b: 'The service offers AI-powered features: an AI assistant, generation of study materials and automated assignment review. These features run only at your initiative.\n\nAI responses are generated automatically and may contain inaccuracies or errors. They are supportive in nature, do not replace a teacher’s professional judgement, and are not legal, medical or other specialist advice — treat them critically and verify important facts yourself. AI review is started by the teacher, and the teacher can change the grade it produces.\n\nYou may not use AI features to create unlawful content, to circumvent the rules of an educational institution, or to mislead other users.' },
      { t: 'Study materials and user content', b: 'The rights to material you create or upload in the service — assignments, answers, study files and materials used with the AI assistant — remain with you or their respective rights holders.\n\nBy uploading content, you grant us a limited right to store, process and display it to the extent needed to run the service: showing it to members of your class, syncing it across your devices, letting the AI assistant work with your materials, and performing the functions you request.\n\nYou confirm that you hold the rights necessary to post the material. We may remove content that breaches these Terms or the law.' },
  ...
  kk: {
    ...
    sections: [
      ...
      { t: 'Мінез-құлық ережелері', b: 'Chatra — оқу ортасы, сондықтан біз сервисті адал және жауапты пайдалануды күтеміз. Қорлайтын, кемсітушілік сипатындағы, алаяқтық немесе зиянды материалдар, заңды немесе басқалардың құқықтарын бұзатын кез келген мазмұн орналастыруға, сондай-ақ сервисті академиялық адалдықты бұзу үшін пайдалануға — мысалы, ИИ жауаптарын оқу орнының ережелеріне қайшы өз жұмысыңыз ретінде тапсыруға — тыйым салынады.\n\nМұндай бұзушылықтарға мүлдем төзбеушілік саясаты қолданылады: бұзушылық мазмұны жойылады, ал бұзушының сервиске қолжетімділігі шектелуі немесе тоқтатылуы мүмкін.' },
      { t: 'Жасанды интеллектті пайдалану', b: 'Сервисте жасанды интеллектке негізделген функциялар бар: ИИ-көмекші, оқу материалдарын жасау және тапсырмаларды автоматты тексеру. Бұл функциялар тек сіздің бастамаңызбен іске қосылады.\n\nИИ жауаптары автоматты түрде қалыптасады және дәл болмауы немесе қателер қамтуы мүмкін. Олар көмекші сипатта болады, оқытушының кәсіби бағасын алмастырмайды және заңдық, медициналық немесе өзге де мамандандырылған кеңес болып табылмайды — оларға сыни тұрғыдан қарап, маңызды деректерді өзіңіз тексеріңіз. ИИ-тексеруді оқытушы іске қосады және қойылған бағаны оқытушы өзгерте алады.\n\nИИ функцияларын құқыққа қайшы мазмұн жасау, оқу орнының ережелерін айналып өту немесе басқа пайдаланушыларды жаңылыстыру үшін пайдалануға тыйым салынады.' },
      { t: 'Оқу материалдары мен пайдаланушы контенті', b: 'Сервисте өзіңіз жасайтын немесе жүктейтін материалдарға — тапсырмалар, жауаптар, оқу файлдары және ИИ-көмекшімен жұмыс үшін пайдаланылатын материалдарға — құқықтар сізде немесе олардың құқық иелерінде қалады.\n\nКонтент жүктей отырып, сіз бізге оны сервистің жұмысы үшін қажет көлемде сақтауға, өңдеуге және көрсетуге шектеулі құқық бересіз: сыныбыңыздың қатысушыларына көрсету, құрылғылар арасында синхрондау, ИИ-көмекшінің материалдарыңызбен жұмыс істеуі және сұралған функцияларды орындау.\n\nСіз орналастыратын материалдарға қажетті құқықтарыңыз бар екенін растайсыз. Біз осы Шарттарды немесе заңнаманы бұзатын контентті жоюға құқылымыз.' },
