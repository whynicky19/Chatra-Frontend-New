...
.empty-admin-icon{width:56px;height:56px;border-radius:16px;background:var(--teal-l);border:1px solid rgba(0,177,201,.18);display:flex;align-items:center;justify-content:center;color:var(--teal)}
