    ...
    <div class="chat-list-panel">
      ...
      <div v-show="!searchQ" class="chats-scroll">
        ...
        <div v-else-if="!chatsStore.chats.length" class="empty" style="padding:28px 16px">
          <div class="empty-chat-icon"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div>
    ...
    <div class="chat-main">
      <Transition name="chat-switch" mode="out-in">
        ...
        <div v-else class="no-chat" key="empty">
          <div class="no-chat-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div>
...
const displayName=(u:any):string=>nickRegistry.value[u.id]||u.full_name||u.email.split('@')[0]
...
.clp-title{font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',Roboto,sans-serif;font-size:16px;font-weight:700;color:var(--text1)}
...
.no-chat-title{font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',Roboto,sans-serif;font-size:16px;font-weight:700;color:var(--text3)}
