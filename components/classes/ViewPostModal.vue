  ...
  <div class="overlay" @click.self="$emit('close')">
    <div class="modal anim-scale" style="max-width:580px">
      <div class="modal-head">
        <div>
          <div :class="['vp-badge',post.type==='lecture'?'lec':'hw']">
            <svg v-if="post.type==='lecture'" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg>
            <svg v-else width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
            {{post.type==='lecture'?'Лекция':'Домашнее задание'}}
          </div>
      ...
      <div v-if="attachedFiles.length" class="vp-files">
        ...
        <a
          ...
          href="#"
          class="vp-file-row"
          @click.prevent="openPreview(f.url, f.name)"
        >
          <span class="file-type-badge-sm">{{f.ext?.toUpperCase() || 'FILE'}}</span>
