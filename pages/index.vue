...
const allClasses = computed(() =>
  allPosts.value
    .map(p => { try { const b=JSON.parse(p.body); return b.type==='class' ? {...p,...b,title:p.title,cover_image:b.cover_image||null,description:b.description||'',teacher_name:b.teacher_name||b.teacher||''} : null } catch { return null } })
