<template>
  <div class="pg">
    <div class="pg-head">
      <div class="head-icon">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--text3)" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
      </div>
      <div>
          ...
          <div class="day-detail">
            ...
            <div v-for="item in dayItems" :key="item.id" class="detail-card" @click="goToAssignment(item)">
              ...
              <div class="detail-info">
                ...
                <div class="detail-time" :style="{ color: item.submitted ? 'var(--green)' : parseUtc(item.deadline).getTime() - Date.now() < 86400000 ? 'var(--red)' : 'var(--text3)' }">
...
.detail-count{background:var(--surface2);color:var(--text3);font-size:11px;font-weight:800;padding:2px 8px;border-radius:100px}
...
.detail-check.done{background:var(--green-l);border-color:var(--green);color:var(--green)}
.detail-info{flex:1;min-width:0}
.detail-class{font-size:10px;font-weight:700;color:var(--text3);text-transform:uppercase;letter-spacing:.06em;margin-bottom:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
